...
plt.annotate('a',(0.06,1.1),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('b',(0.31,1.1),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('c',(0.56,1.1),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('d',(0.81,1.1),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('e',(0.06,0.68),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('f',(0.31,0.68),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('g',(0.56,0.68),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')
plt.annotate('h',(0.81,0.68),annotation_clip=False,xycoords='figure fraction', fontsize=40,**csfont,weight='bold')


plt.savefig('Plots/Fig_1_Distribution.pdf' , bbox_inches='tight',dpi=250)
